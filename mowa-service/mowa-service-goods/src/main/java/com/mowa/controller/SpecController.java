...
public class SpecController {
    ...
    @ApiOperation(value = "根据分类id查询Spec",notes = "根据分类id查询Spec",tags = {"SpecController"})
    @GetMapping("/category/{categoryId}")
    public Result findByCategoryId(@PathVariable("categoryId") String categoryId){
      return Result.success( specService.findByCategoryId(categoryId) );
    }
}
