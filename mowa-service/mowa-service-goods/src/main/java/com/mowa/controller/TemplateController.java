...
import com.mowa.goods.pojo.Template;
import com.mowa.service.TemplateService;
...
public class TemplateController {
    ...
    public Result<List<Template>> findList(@RequestBody(required = false) @ApiParam(name = "Template对象",value = "传入JSON数据",required = false) Template template){
        ...
        return new Result<List<Template>>(true,StatusCodeEnum.SUCCESS.getCode(),"查询成功",list);
    }
    ...
    public Result<Template> findById(@PathVariable Integer id){
        ...
        return new Result<Template>(true,StatusCodeEnum.SUCCESS.getCode(),"查询成功",template);
    }
