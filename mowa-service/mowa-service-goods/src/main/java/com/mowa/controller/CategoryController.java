...
public class CategoryController {
    ...
    @ApiOperation(value = "根据父级ID查询Category",notes = "根据父级ID查询Category",tags = {"CategoryController"})
    @GetMapping("/list/{pid}")
    public Result<List<Category>> findListByParentId(@PathVariable("pid") String pid){
        return Result.success( categoryService.findByParentId( pid ) );
    }
}
