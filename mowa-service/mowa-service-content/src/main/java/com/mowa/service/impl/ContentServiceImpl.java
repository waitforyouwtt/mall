...
import com.mowa.dao.ContentMapper;
    ...
    public Example createExample(Content content){
        ...
        if(content!=null){
            ...
            if(!StringUtils.isEmpty(content.getCreateBy())){
                    criteria.andEqualTo("createBy",content.getCreateBy());
            }
            // 
            if(!StringUtils.isEmpty(content.getUpdateBy())){
                    criteria.andEqualTo("updateBy",content.getUpdateBy());
            }
            // 
            if(!StringUtils.isEmpty(content.getCreateTime())){
                    criteria.andEqualTo("createTime",content.getCreateTime());
            }
            // 
            if(!StringUtils.isEmpty(content.getUpdateTime())){
                    criteria.andEqualTo("updateTime",content.getUpdateTime());
            }
        }
        return example;
    }
