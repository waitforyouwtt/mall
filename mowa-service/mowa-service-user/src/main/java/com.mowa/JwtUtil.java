...
public class JwtUtil {
   ...
   // @Value( "${mowa.jwt.token.expiration.time}" )
     ...
     * @return
     */
    public static String createJWT(Long ttlMillis, UserInfo userInfo){
        ...
        claims.put("userNickname",userInfo.getUserNickname());
     ...
     * @return
     */
    public static Boolean isVerify(String token, UserInfoView user) {
        //签名秘钥，和生成的签名的秘钥一模一样
